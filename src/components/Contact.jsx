...
const Contact = () => {
  return (
    <div className='flex my-[36px] bg-[#fb98bb] p-4 text-[#a22752] rounded-md'>
        ...
        <div className='flex-1 flex items-center flex-col justify-center border-l-2 border-l-[#a22752]'>
            <input type="text" placeholder='Your email' className='rounded-md text-[14px] p-2 w-[200px]'/>
            <button className='rounded-xl mt-4 bg-[#a22752] text-white py-1 px-3 hover:opacity-60'>Sign up</button>
        </div>
    </div>
  )
}
